...
func TestVNextExactScalars(t *testing.T) {
...
func TestVNextScalarJSONRoundTrips(t *testing.T) {
	values := []any{
...
func TestVNextScalarJSONRejectsNonCanonicalForms(t *testing.T) {
...
func TestVNextPathsAndURLs(t *testing.T) {
