...
export function ApiExplorerPage({
  ...
  if (!selected) {
    return (
      <VStack gap={4} as="section" data-scenery-ui="ConsoleAPIExplorer">
  ...
  return (
    <section {...stylex.props(styles.twoColumn)} data-scenery-ui="ConsoleAPIExplorer">
      <Section padding={4}>
...
export function ServiceCatalogPage({
  ...
  if (services.length === 0) {
    return (
      <section data-scenery-ui="ConsoleServiceCatalog">
  ...
  return (
    <section {...stylex.props(styles.twoColumn)} data-scenery-ui="ConsoleServiceCatalog">
      <Section padding={4}>
        <VStack gap={4} as="section">
...
export function TracesWorkbenchPage({
  ...
  return (
    <VStack gap={4} as="section" data-scenery-ui="ConsoleTraces">
      <Section padding={4}>
        <section {...stylex.props(styles.actionBar)}>
...
export function DatabasesWorkbenchPage({
  ...
  if (databases.length === 0) {
    return (
      <VStack gap={4} as="section" data-scenery-ui="ConsoleDatabases">
...
export function CronPage({ status, traces }: { status: AppStatus | null; traces: TraceSummary[] }) {
  ...
  return (
    <VStack gap={4} as="section" data-scenery-ui="ConsoleCron">
...
export function LogsAndOutputPage({ outputs }: { outputs: ProcessOutput[] }) {
  ...
  return (
    <Section padding={0} xstyle={styles.tableFrame} data-scenery-ui="ConsoleProcessOutput">
