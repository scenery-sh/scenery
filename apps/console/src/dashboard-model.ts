...
export type Page = 'Overview' | 'API' | 'Catalog' | 'Logs' | 'Output' | 'Traces' | 'Databases' | 'Storage' | 'Cron'
...
export const pages: Page[] = ['Overview', 'API', 'Catalog', 'Logs', 'Output', 'Traces', 'Databases', 'Storage', 'Cron']
