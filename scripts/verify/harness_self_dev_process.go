...
func runHarnessSharedBuildProcessProof(parent context.Context, repoRoot string) (map[string]any, error) {
	...
	return map[string]any{
		...
		"restored_external_inputs_not_cached_without_change_time": true,
		"temporarily_enabled_ignored_go_input_not_cached":         true,
		"temporary_embed_in_empty_directory_not_cached":           true,
