...
func ensureAssistantBootstrapService() {
	...
	if global.services.Has(assistantRuntimeBootstrapService) {
		return
	}
	if err := serviceRegistryLocked().Register(NativeServiceRegistration{
		Address:    assistantRuntimeBootstrapService,
