...
func invokeRegisteredContractBindingJSON(ctx context.Context, registration ContractInternalBindingRegistration, address, callerPackage string, input []byte) ([]byte, error) {
