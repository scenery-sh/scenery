...
Go `service.config` keys are dynamic but must be lower-snake and exactly match same-named typed package inputs; their input phase and sensitivity define the generated constructor config.
