...
- Use `scenery build` for a deployable binary artifact, then launch that generated binary directly when a headless app runtime is needed.
...
- Operator-launched generated binaries can use process environment without a `.env` file.
