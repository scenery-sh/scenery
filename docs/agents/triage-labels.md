...
| Triage role | Local `Status:` value | Meaning                                  |
| ------------------------- | --------------------- | ---------------------------------------- |
...
Wayfinding execution tickets use `open`, `claimed`, and `resolved` instead;
see [the issue workflow](issue-tracker.md#wayfinding-operations).
