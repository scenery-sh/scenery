...
* Decision: Public deploy host lookup lives in the agent server request path and reloads `<agent home>/deploy.json` on each public request instead of adding a registry control RPC in this slice.
