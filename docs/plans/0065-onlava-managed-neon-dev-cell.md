...
- 2026-06-08: A configured branch-driver executable is the narrowest honest bridge from generated local dev-cell state to real self-hosted branch creation. It lets Onlava own pin/lease/env semantics without guessing unstable upstream `cargo neon` command shapes inside the public CLI.
