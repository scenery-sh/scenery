...
`scenery db psql`, worktree, and harness commands, and receive the
...
agents inspect status, and app SQL can use native PostgreSQL 18
...
- `scenery up`, `scenery db psql`, DB setup, and worktree branch pins,
