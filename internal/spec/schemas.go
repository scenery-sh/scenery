...
var resourceSchemas = map[string]resourceSchema{
	...
	"scenery.table-page":      {"contract", []string{"path", "source", "title", "column"}, []string{"path", "source", "items", "title", "description", "page_size", "row_link", "nav_group", "nav_order", "nav_label", "nav_icon", "nav_active_paths"}, nil},
