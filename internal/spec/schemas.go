...
var resourceSchemas = map[string]resourceSchema{
	...
	"scenery.typescript-client": {"implementation", []string{"gateways", "package", "module", "runtime", "output_root"}, []string{"gateways", "package", "module", "runtime", "output_root", "materialization", "typescript_version", "javascript_target", "include", "react", "dev_runtime"}, nil},
	...
	"scenery.operation":      {"contract", []string{"input", "handler"}, []string{"service", "input"}, nil},
	...
	"scenery.page":    {"contract", []string{"path"}, []string{"path", "load", "application_key", "access_key"}, nil},
	...
	"scenery.table-page":      {"contract", []string{"path", "source", "title", "column"}, []string{"path", "source", "items", "metadata", "title", "description", "loading_label", "error_title", "page_size", "row_link", "hide_header", "scroll", "application_key", "access_key", "nav_group", "nav_order", "nav_label", "nav_icon", "nav_active_paths"}, nil},
	"scenery.split-page":      {"contract", []string{"path", "source", "title", "sidebar", "detail"}, []string{"path", "source", "title", "aria_label", "sidebar_label", "query_parameter", "application_key", "access_key", "nav_group", "nav_order", "nav_label", "nav_icon", "nav_active_paths"}, nil},
	"scenery.content-page":    {"contract", []string{"path", "title", "content"}, []string{"path", "source", "title", "aria_label", "max_width", "application_key", "access_key", "nav_group", "nav_order", "nav_label", "nav_icon", "nav_active_paths"}, nil},
	"scenery.workspace-page":  {"contract", []string{"path", "title", "tab"}, []string{"path", "title", "presentation", "application_key", "access_key", "nav_group", "nav_order", "nav_label", "nav_icon", "nav_active_paths"}, nil},
	"scenery.detail-page":     {"contract", []string{"path", "source", "title", "section"}, []string{"path", "source", "title", "description", "loading_label", "error_title", "presentation", "application_key", "access_key", "nav_group", "nav_order", "nav_label", "nav_icon", "nav_active_paths"}, nil},
