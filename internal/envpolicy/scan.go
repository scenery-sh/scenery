...
func looksLikeEnvName(token string) bool {
	...
	case "DATABASE_URL", "API_BASE_URL", "PUBLIC_APP_URL", "AUTH_COOKIE_DOMAIN", "AUTH_EMAIL_FROM", "JWT_SECRET",
		...
		"TEMPORAL_ADDRESS", "TEMPORAL_NAMESPACE", "TEMPORAL_API_KEY", "TEMPORAL_TLS_SERVER_NAME", "TEMPORAL_TLS_CA_CERT_FILE", "TEMPORAL_TLS_CERT_FILE", "TEMPORAL_TLS_KEY_FILE",
		"OTEL_EXPORTER_OTLP_METRICS_ENDPOINT", "OTEL_EXPORTER_OTLP_LOGS_ENDPOINT", "OTEL_EXPORTER_OTLP_TRACES_ENDPOINT",
		"VITE_API_BASE_URL", "VITE_ELECTRIC_URL",
		"ELECTRIC_URL", "ELECTRIC_PORT", "ELECTRIC_INSECURE", "ELECTRIC_USAGE_REPORTING", "ELECTRIC_REPLICATION_STREAM_ID":
		return true
	default:
		return false
	}
