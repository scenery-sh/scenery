...
func renderProviderCRUDAdapterSource(contractRevision, packageIdentity, packageVersion, packageABI, contractImport, packageName string, service Resource, operations, bindings, resources []Resource, covered []string, providerABIs map[string]string) ([]byte, error) {
