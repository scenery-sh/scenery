...
func renderGoContractFiles(result *Result) ([]generatedFile, error) {
	...
	if containsExactString(result.Manifest.Profiles, "scenery.go-implementation/v1") {
...
func trustedGeneratedArtifact(_, _ string, contents []byte) bool {
	return bytes.HasPrefix(contents, []byte("// Code generated by Scenery vNext. DO NOT EDIT."))
}
