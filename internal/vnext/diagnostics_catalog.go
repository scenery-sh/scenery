...
SCN1003|language_edition|The language edition declaration is unsupported
...
SCN2204|workflow_profile|Workflow execution requires an unresolved profile
...
SCN2902|patch_shape|A patch lacks schema version range or preconditions
SCN2903|patch_precondition|A patch precondition failed
SCN2904|patch_write_path|A patch path is not writable
SCN2905|patch_version|A patch version range rejects the target package
...
SCN3102|locked_version|A local module version violates its constraint
...
SCN7001|unsupported_profile|A required edition profile is unsupported
SCN7002|unsupported_execution_profile|A required durable or workflow execution profile is unsupported
SCN7003|unsupported_data_profile|The data profile is required but unsupported
SCN7004|unsupported_deployment_profile|The deployment profile is required but unsupported
SCN7005|unsupported_events_profile|The events profile is required but unsupported
SCN7006|unsupported_ui_profile|The UI profile is required but unsupported
SCN7007|unsupported_patches_profile|The patches profile is required but unsupported
SCN7008|unsupported_streaming_profile|Streaming or server-sent events require an unsupported profile
