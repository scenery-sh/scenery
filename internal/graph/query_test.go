...
func TestGraphClosureIncludesDependenciesAndDependents(t *testing.T) {
	manifest := &Manifest{Resources: []Resource{
		...
		{Address: "house/operation/process", Module: "house", Kind: "scenery.operation", Spec: map[string]any{"service": map[string]any{"$ref": "service.house"}}},
		{Address: "house/binding/process", Module: "house", Kind: "scenery.binding", Spec: map[string]any{"operation": map[string]any{"$ref": "operation.process"}}},
	}}
...
func TestContextBundleHonorsSerializedByteLimitIncludingContinuation(t *testing.T) {
	manifest := &Manifest{ContractRevision: "sha256:contract", Resources: []Resource{
		{Address: "house/service/house", Module: "house", Kind: "scenery.service", Spec: map[string]any{"description": strings.Repeat("x", 2048)}},
		{Address: "house/operation/process", Module: "house", Kind: "scenery.operation", Spec: map[string]any{"service": map[string]any{"$ref": "service.house"}}},
	}}
...
func TestContextBundleProjectsRequestedSchemasDiagnosticsAndProvenance(t *testing.T) {
	manifest := &Manifest{ContractRevision: "sha256:contract", Resources: []Resource{{
		Address: "house/record/item", Module: "house", Kind: "scenery.record", Name: "item", Origin: Origin{Kind: "authored", SourceID: "src_item"}, Spec: map[string]any{},
	}}}
	...
	if bundle.Schemas["scenery.record"] == nil || bundle.Provenance["house/record/item"].SourceID != "src_item" || len(bundle.Diagnostics) != 1 {
		t.Fatalf("bundle = %#v", bundle)
	}
