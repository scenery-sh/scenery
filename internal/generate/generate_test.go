...
`)...)
	...
	for _, fragment := range []string{"defineTablePageSlots<SceneRow", "client?: PublicApiClient", "providedClient ?? defaultClient", "client.sceneApiList", "value is SceneName", "Code generated by Scenery"} {
