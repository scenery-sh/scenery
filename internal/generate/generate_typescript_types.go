...
func renderTSMetadata(target Resource, manifest *Manifest, bindings, reachable []Resource, revision string) string {
	...
	b, _ := json.MarshalIndent(map[string]any{
		...
		"compatibilityCatalog": "scenery.compatibility-core", "generator": "scenery.generate.typescript",
