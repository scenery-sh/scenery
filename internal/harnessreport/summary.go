...
func summaryDiagnosticFile(path string) string {
	...
	for _, prefix := range []string{"cmd/", "internal/", "runtime/", "auth/", "docs/", "ui/", "tools/typescript/", "testdata/", "scripts/"} {
...
func NormalizeLikelyPath(path string) string {
	...
	for _, marker := range []string{"/cmd/", "/internal/", "/runtime/", "/auth/", "/docs/", "/ui/", "/tools/typescript/", "/testdata/", "/scripts/"} {
