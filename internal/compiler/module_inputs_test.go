...
func TestResolveModuleInstanceInputsSubstitutesTypedResources(t *testing.T) {
	rootResources := []Resource{{
		Address: "app/data_source/database", Module: "app", Kind: "scenery.data-source", Name: "database",
	...
	packageResources := []Resource{{
		Address: "house/service/house", Module: "house", Kind: "scenery.service", Name: "house",
...
func TestResolveModuleInstanceInputsRejectsMissingAndWrongKind(t *testing.T) {
	...
	packageResources := []Resource{{Address: "house/service/house", Module: "house", Kind: "scenery.service", Spec: map[string]any{"dependency": map[string]any{"name": "database", "instance": map[string]any{"$ref": "var.database"}}}}}
	module := &Block{Type: "module", Labels: []string{"house"}, Attributes: map[string]Expression{}}
	...
	root := []Resource{{Address: "app/http_gateway/public", Module: "app", Kind: "scenery.http-gateway", Name: "public"}}
