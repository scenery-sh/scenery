...
func TestScheduleValidationTypeChecksCompleteStaticInput(t *testing.T) {
	...
	resources = append(resources, Resource{
		Address: "house/schedule/nightly", Module: "house", Name: "nightly", Kind: "scenery.schedule",
		Spec: map[string]any{
...
func TestEventValidationChecksBusContractMappingAndDeliveryPolicy(t *testing.T) {
	...
	resources = append(resources,
		Resource{Address: "app/event_bus/events", Module: "app", Name: "events", Kind: "scenery.event-bus", Spec: map[string]any{"provider": map[string]any{"$ref": "provider.kafka"}}},
		Resource{Address: "house/event/registered", Module: "house", Name: "registered", Kind: "scenery.event", Spec: map[string]any{"payload": map[string]any{"$ref": "record.event_payload"}, "version": "1"}},
		Resource{Address: "house/binding/consume", Module: "house", Name: "consume", Kind: "scenery.binding", Spec: map[string]any{
...
func TestEventEmissionValidationChecksOutcomePayloadType(t *testing.T) {
	...
	resources = append(resources,
		Resource{Address: "app/event_bus/events", Module: "app", Name: "events", Kind: "scenery.event-bus", Spec: map[string]any{"provider": map[string]any{"$ref": "provider.kafka"}}},
		Resource{Address: "house/event/registered", Module: "house", Name: "registered", Kind: "scenery.event", Spec: map[string]any{"payload": map[string]any{"$ref": "record.event_payload"}, "version": "1"}},
		Resource{Address: "house/event_emission/registered", Module: "house", Name: "registered", Kind: "scenery.event-emission", Spec: map[string]any{
...
func eventProfileFixtureResources() []Resource {
	return []Resource{
		{Address: "house/record/process_input", Module: "house", Name: "process_input", Kind: "scenery.record", Spec: map[string]any{"field": []any{
			map[string]any{"name": "tenant_id", "type": map[string]any{"$ref": "string"}}, map[string]any{"name": "scene_id", "type": map[string]any{"$ref": "string"}},
		}}},
		{Address: "house/record/event_payload", Module: "house", Name: "event_payload", Kind: "scenery.record", Spec: map[string]any{"field": map[string]any{"name": "event_id", "type": map[string]any{"$ref": "string"}}}},
		{Address: "house/operation/process", Module: "house", Name: "process", Kind: "scenery.operation", Spec: map[string]any{
		...
		{Address: "house/execution/process", Module: "house", Name: "process", Kind: "scenery.execution", Spec: map[string]any{"operation": map[string]any{"$ref": "operation.process"}, "mode": "direct"}},
	}
}
