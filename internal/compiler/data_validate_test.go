...
func TestFixtureSeedPlanIsEnvironmentScopedAndDeterministic(t *testing.T) {
	...
	resources = append(resources, Resource{Address: "house/fixture/demo_scenes", Module: "house", Name: "demo_scenes", Kind: "scenery.fixture", Spec: map[string]any{
...
func TestSQLViewResultColumnsAreVerified(t *testing.T) {
	...
	resources = append(resources,
		Resource{Address: "app/module/house", Module: "app", Name: "house", Kind: "scenery.module", Spec: map[string]any{"source": "./house", "workspace_package_root": "house"}},
		Resource{Address: "house/view/scenes", Module: "house", Name: "scenes", Kind: "scenery.view", Spec: map[string]any{"data_source": map[string]any{"$ref": "app/data_source/database"}, "input": map[string]any{"$ref": "record.scene_row"}, "result": map[string]any{"$expression": "list(record.scene_row)"}, "implementation": map[string]any{"kind": "sql_query", "file": "queries/scenes.sql", "name": "ListScenes"}}},
	)
...
func TestDataValidationRejectsInvalidEntityMappingAndProductionFixture(t *testing.T) {
	...
	for index := range resources {
		if resources[index].Kind == "scenery.entity" {
			resources[index].Spec["field"] = map[string]any{"name": "missing", "column": "missing", "primary_key": true}
		}
	}
	resources = append(resources, Resource{Address: "house/fixture/scenes", Module: "house", Name: "scenes", Kind: "scenery.fixture", Spec: map[string]any{
...
func TestCRUDExpansionRejectsDerivedAddressCollision(t *testing.T) {
	resources := dataProfileFixtureResources()
	resources = append(resources, Resource{Address: "house/operation/scene_api_get", Module: "house", Name: "scene_api_get", Kind: "scenery.operation", Origin: Origin{Kind: "authored"}})
...
func dataProfileFixtureResources() []Resource {
	return []Resource{
		{Address: "app/provider/postgres", Module: "app", Name: "postgres", Kind: "scenery.provider", Spec: map[string]any{"source": "registry.scenery.dev/core/postgres"}},
		{Address: "app/data_source/database", Module: "app", Name: "database", Kind: "scenery.data-source", Spec: map[string]any{"provider": map[string]any{"$ref": "provider.postgres"}, "lifecycle": "managed", "require_capabilities": []any{"sql.query/v1"}}},
		{Address: "house/record/scene_row", Module: "house", Name: "scene_row", Kind: "scenery.record", Spec: map[string]any{"field": []any{
		...
		{Address: "house/entity/scene", Module: "house", Name: "scene", Kind: "scenery.entity", Spec: map[string]any{
		...
		{Address: "house/crud/scene_api", Module: "house", Name: "scene_api", Kind: "scenery.crud", Origin: Origin{Kind: "authored", SourceID: "src_house"}, Spec: map[string]any{
