...
func TestSecurityValidationRejectsImpureRulesAndPipelineAmbiguity(t *testing.T) {
	resources := []Resource{
		{Address: "app/authorization/member", Kind: "scenery.authorization", Spec: map[string]any{
		...
		{Address: "app/pipeline/default", Kind: "scenery.pipeline", Spec: map[string]any{"step": []any{
...
func TestAuthorizationDefaultsAndAcceptsDenyRules(t *testing.T) {
	resources := []Resource{{Address: "app/authorization/member", Kind: "scenery.authorization", Spec: map[string]any{
...
func TestBindingAuthenticationRejectsUnsupportedProviderAndScheme(t *testing.T) {
	authentication := Resource{Address: "app/authentication/standard", Module: "app", Kind: "scenery.authentication", Name: "standard", Spec: map[string]any{
		"provider": map[string]any{"$ref": "std.provider.other"}, "scheme": "magic",
	}}
	binding := Resource{Address: "house/binding/process", Module: "house", Kind: "scenery.binding", Spec: map[string]any{
...
func TestCustomMiddlewareFailsAsUnsupportedProfile(t *testing.T) {
	resource := Resource{Address: "house/middleware/custom", Module: "house", Kind: "scenery.middleware", Origin: Origin{Kind: "authored"}, Spec: map[string]any{
...
func TestAuthorizationRulesAreTypeCheckedAgainstBindingInput(t *testing.T) {
	resources := []Resource{
		{Address: "house/record/input", Module: "house", Kind: "scenery.record", Name: "input", Spec: map[string]any{"field": map[string]any{"name": "count", "type": map[string]any{"$ref": "int32"}}}},
		{Address: "house/operation/process", Module: "house", Kind: "scenery.operation", Name: "process", Spec: map[string]any{"input": map[string]any{"$ref": "record.input"}}},
		{Address: "app/authorization/member", Module: "app", Kind: "scenery.authorization", Name: "member", Spec: map[string]any{
