...
func TestHTTPValidationRejectsUnsafeOrIncompleteBindings(t *testing.T) {
	resources := []Resource{
		{Address: "app/http_gateway/public", Kind: "scenery.http-gateway", Spec: map[string]any{"exposure": "internet", "base_path": "/api"}},
		{Address: "house/operation/get", Module: "house", Kind: "scenery.operation", Spec: map[string]any{"input": map[string]any{"$ref": "string"}}},
		{Address: "house/execution/get", Module: "house", Kind: "scenery.execution", Spec: map[string]any{"operation": map[string]any{"$ref": "operation.get"}, "mode": "direct"}},
		{Address: "house/binding/get", Module: "house", Kind: "scenery.binding", Spec: map[string]any{
...
func TestHTTPValidationAcceptsExplicitDenyAllAuthorization(t *testing.T) {
	resources := []Resource{
		{Address: "app/http_gateway/private", Kind: "scenery.http-gateway", Spec: map[string]any{"exposure": "internal", "base_path": "/"}},
		{Address: "house/binding/closed", Module: "house", Kind: "scenery.binding", Spec: map[string]any{
...
func TestHTTPValidationRejectsStreamingWithoutAStreamingProfile(t *testing.T) {
	resources := []Resource{
		...
		{Address: "house/binding/stream", Module: "house", Kind: "scenery.binding", Spec: map[string]any{
...
func TestHTTPRouteKeyJoinsGatewayBasePath(t *testing.T) {
	resources := []Resource{
		...
		{Address: "house/binding/one", Module: "house", Kind: "scenery.binding", Spec: map[string]any{"gateway": map[string]any{"$ref": "app/http_gateway/public"}, "protocol": "http", "http": map[string]any{"method": "GET", "path": "/users/{id}"}}},
		{Address: "house/binding/two", Module: "house", Kind: "scenery.binding", Spec: map[string]any{"gateway": map[string]any{"$ref": "app/http_gateway/public"}, "protocol": "http", "http": map[string]any{"method": "GET", "path": "/users/{name}"}}},
	}
	diagnostics := validateHTTPResources(resources)
...
func TestHTTPValidationChecksCodecExposureAndForwardedTrust(t *testing.T) {
	resources := []Resource{
		{Address: "app/http_gateway/private", Kind: "scenery.http-gateway", Spec: map[string]any{
...
func TestHTTPValidationChecksPathMappingsAndResponseCoverage(t *testing.T) {
	resources := []Resource{
		{Address: "app/http_gateway/public", Kind: "scenery.http-gateway", Spec: map[string]any{"exposure": "internet", "base_path": "/"}},
		{Address: "house/operation/get", Module: "house", Kind: "scenery.operation", Spec: map[string]any{
...
func TestHTTPValidationRequiresCompleteTypedInputMapping(t *testing.T) {
	resources := []Resource{
		{Address: "app/http_gateway/public", Kind: "scenery.http-gateway", Spec: map[string]any{"exposure": "internet", "base_path": "/"}},
		{Address: "house/record/get_input", Module: "house", Kind: "scenery.record", Spec: map[string]any{"field": []any{
		...
		{Address: "house/operation/get", Module: "house", Name: "get", Kind: "scenery.operation", Spec: map[string]any{
...
func TestHTTPValidationRejectsNonScalarPathAndConflictingBodySelection(t *testing.T) {
	resources := map[string]Resource{
		"house/record/input": {Address: "house/record/input", Module: "house", Kind: "scenery.record", Spec: map[string]any{"field": []any{
	...
	operation := Resource{Address: "house/operation/search", Module: "house", Name: "search", Kind: "scenery.operation", Spec: map[string]any{"input": map[string]any{"$ref": "record.input"}}}
	resources[operation.Address] = operation
	binding := Resource{Address: "house/binding/search", Module: "house", Kind: "scenery.binding"}
...
func TestHTTPResponseMappingsMustReconstructOneCompleteOutcome(t *testing.T) {
	resources := map[string]Resource{
		"house/record/output": {Address: "house/record/output", Module: "house", Kind: "scenery.record", Spec: map[string]any{"field": []any{
	...
	operation := Resource{Address: "house/operation/process", Module: "house", Name: "process", Kind: "scenery.operation", Spec: map[string]any{
		"result": map[string]any{"name": "processed", "type": map[string]any{"$ref": "record.output"}},
	}}
	binding := Resource{Address: "house/binding/process", Module: "house", Kind: "scenery.binding", Spec: map[string]any{"delivery": "call"}}
...
func TestHTTPUnitInputRequiresNoTransportMapping(t *testing.T) {
	operation := Resource{Address: "house/operation/ping", Module: "house", Name: "ping", Kind: "scenery.operation", Spec: map[string]any{"input": map[string]any{"$ref": "std.type.unit"}}}
	binding := Resource{Address: "house/binding/ping", Module: "house", Kind: "scenery.binding"}
...
func TestHTTPMultipartFileRecordsRequireExactRetainedMetadata(t *testing.T) {
	...
	input := Resource{Address: "house/record/input", Module: "house", Kind: "scenery.record", Name: "input", Spec: map[string]any{"field": map[string]any{"name": "asset", "type": map[string]any{"$ref": "record.file"}}}}
	operation := Resource{Address: "house/operation/upload", Module: "house", Kind: "scenery.operation", Name: "upload", Spec: map[string]any{"input": map[string]any{"$ref": "record.input"}}}
	binding := Resource{Address: "house/binding/upload", Module: "house", Kind: "scenery.binding"}
