...
func TestSplitPageExpandsToPageAndRenderer(t *testing.T) {
	resources := []Resource{
		...
		{Address: "house/react_component/pane", Module: "house", Name: "pane", Kind: "scenery.react-component"},
		{Address: "house/react_component/detail", Module: "house", Name: "detail", Kind: "scenery.react-component"},
		{Address: "house/split_page/inbox", Module: "house", Name: "inbox", Kind: "scenery.split-page", Origin: Origin{Kind: "authored"}, Spec: map[string]any{"path": "/inbox", "source": map[string]any{"$ref": "binding.read_http"}, "title": "Inbox", "pane": map[string]any{"component": map[string]any{"$ref": "react_component.pane"}}, "detail": map[string]any{"component": map[string]any{"$ref": "react_component.detail"}}}},
	}
