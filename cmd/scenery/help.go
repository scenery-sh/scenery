...
var helpCommands = []helpCommandEntry{
	...
	},
	{
		...
		Usage: []string{
			...
			"scenery db diff --generated [--app-root <path>] [--json]",
		...
		Subcommands: []string{"psql", "apply", "seed", "setup", "reset", "drop", "diff", "snapshot", "branch", "postgres"},
		Flags:       []string{"--app-root <path>", "--json", "--dry-run", "--generated"},
		JSON:        true,
		Stability:   "stable",
	},
	{
	...
	},
	{
		Command:     "generate",
		Group:       "Generation",
		Summary:     "Generate configured outputs, clients, SQLC artifacts, and data schema.",
		Usage:       []string{"scenery generate [--app-root <path>] [--dry-run] [--json]", "scenery generate client [<app-id>] [--lang typescript] [--output <path>] [--app-root <path>] [--dry-run] [--json]", "scenery generate sqlc [--app-root <path>] [--dry-run] [--json]", "scenery generate data [--app-root <path>] [--dry-run] [--json]"},
		Subcommands: []string{"client", "sqlc", "data"},
	...
	},
	{
		...
		Subcommands: []string{"status", "webui", "ls", "stat", "put", "get", "rm"},
		Flags:       []string{"--json", "--app-root <path>", "--prefix <prefix>", "--cursor <cursor>", "--limit <n>", "--output <file>", "--recursive"},
		JSON:        true,
		Stability:   "beta",
	},
	{
	...
	},
	{
		...
		Subcommands: []string{"bindings", "typescript", "temporal", "deployment"},
	...
	{
		Command:     "worker temporal",
		Group:       "Runtime",
		Summary:     "Inspect and prune Temporal dev workflow state.",
		Usage:       []string{"scenery worker temporal prune --stale [--yes] [--app-root <path>] [--json]"},
		Subcommands: []string{"prune"},
		Flags:       []string{"--stale", "--yes", "--app-root <path>", "--json"},
		Notes:       []string{"`prune --stale` is fail-closed: without `--yes`, it only reports stale workflow candidates."},
		JSON:        true,
		Stability:   "beta",
	},
	{
	...
	},
	{
		...
		Subcommands: []string{"app", "routes", "services", "endpoints", "models", "views", "wire", "build", "paths", "generators", "temporal", "observability", "validation", "docs", "harness"},
