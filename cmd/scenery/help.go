...
var helpCommands = []helpCommandEntry{
	...
	},
	{
		Command: "db",
		Group:   "Database",
		Summary: "Manage service database lifecycle, snapshots, branches, server status, and local shells.",
		Usage: []string{
		...
		Subcommands: []string{"list", "path", "shell", "apply", "seed", "setup", "reset", "drop", "diff", "snapshot", "branch", "server"},
