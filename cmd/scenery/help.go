...
var helpCommands = []helpCommandEntry{
	...
	},
	{
		Command: "db",
		Group:   "Database",
		Summary: "Manage SQLite database lifecycle, snapshots, branches, and local shells.",
		Usage: []string{
			"scenery db list|path|shell [--app-root <path>] [--service <name>]",
		...
		Subcommands: []string{"list", "path", "shell", "apply", "seed", "setup", "reset", "drop", "diff", "snapshot", "branch"},
