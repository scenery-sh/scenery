...
var helpCommands = []helpCommandEntry{
	...
	},
	{
		...
		Usage:       []string{"scenery framework use [--source <checkout>] [--app-root <path>] [-o human|json]", "scenery framework inspect [--app-root <path>] [-o human|json]"},
		Subcommands: []string{"use", "inspect"},
		Flags:       []string{"--source <checkout>", "--app-root <path>", "-o human|json"},
		JSON:        true,
		Stability:   "stable",
	},
	{
