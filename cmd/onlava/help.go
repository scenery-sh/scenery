...
var helpCommands = []helpCommandEntry{
	...
	},
	{
		...
		Usage:       []string{"onlava system agent [--socket <path>] [--router-listen <addr>] [--router-tls|--router-http] [--trust] [--json]", "onlava system agent restart [--socket <path>] [--router-listen <addr>] [--router-tls|--router-http] [--trust] [--json]", "onlava system edge install|trust|status|restart|uninstall|dns|privileged [--json]", "onlava system toolchain list|sync|verify [--json] [--tool <name>] [--images]", "onlava system toolchain path [--json] --tool <name>", "onlava system trust [--json]"},
