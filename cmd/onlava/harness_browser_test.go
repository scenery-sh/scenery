		...
		return harnessUIBrowserResult{
			Routes: []harnessUIRoute{{
				...
				Journey: []harnessUIJourneyResult{{
					...
					Kind:     "selector",
					Selector: `[data-onlava-ui="AppSelector"]`,
					Count:    1,
					Found:    true,
					Required: true,
				}},
				DOMSnapshot: ".onlava/harness/ui/dom/dashboard-home.json",
			}},
			Artifacts: []harnessArtifact{
				{Name: "dom:dashboard-home", Path: ".onlava/harness/ui/dom/dashboard-home.json", SchemaVersion: "onlava.harness.ui.dom.v1", Exists: true},
				{Name: "console", Path: ".onlava/harness/ui/console.jsonl", Exists: true},
			},
		}, nil
	}
