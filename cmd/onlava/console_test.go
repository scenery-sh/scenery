...
func TestRunConsoleSetupOutputFormatsAtlasLines(t *testing.T) {
	...
	console.SetupOutput("==> Atlas target: postgres://onlava:***@127.0.0.1:52463/demo?sslmode=disable", "stdout")
	...
	for _, want := range []string{
		"  • Atlas target: postgres://onlava:***@127.0.0.1:52463/demo?sslmode=disable\n",
